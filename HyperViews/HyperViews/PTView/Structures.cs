...
namespace PTViewClient.PTView
{
    ...
    public class CR3REG
    {
        ...
        public CR3REG(ulong value)
        {
            Value = value;
        }
        public ulong reserved1 { get => ReadBits(Value, 0, 3); }
        public ulong page_level_write_through { get => ReadBits(Value, 3, 1); }
        public ulong page_level_cache_disable { get => ReadBits(Value, 4, 1); }
        public ulong reserved2 { get => ReadBits(Value, 5, 7); }
        public ulong dirbase { get => ReadBits(Value, 12, 36); }
        public ulong reserved3 { get => ReadBits(Value, 48, 16); }
    }
